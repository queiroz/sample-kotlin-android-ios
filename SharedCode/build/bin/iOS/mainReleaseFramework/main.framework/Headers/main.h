...
@class MainQuestion, MainQuestionData;
...
@interface MainQuestion : KotlinBase
...
- (MainQuestion *)doCopyId:(int32_t)id name:(NSString *)name __attribute__((swift_name("doCopy(id:name:)")));
...
@interface MainQuestionData : KotlinBase
- (instancetype)initWithQuestions:(NSArray<MainQuestion *> *)questions __attribute__((swift_name("init(questions:)"))) __attribute__((objc_designated_initializer));
- (NSArray<MainQuestion *> *)component1 __attribute__((swift_name("component1()")));
- (MainQuestionData *)doCopyQuestions:(NSArray<MainQuestion *> *)questions __attribute__((swift_name("doCopy(questions:)")));
@property (readonly) NSArray<MainQuestion *> *questions;
@end;
...
@interface MainCommonKt : KotlinBase
